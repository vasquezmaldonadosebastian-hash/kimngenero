...
> Estado: historico / no normativo
>
> Este documento describe una etapa anterior del repositorio y ya no representa el estado real actual.
> El plan vigente de saneamiento es [docs/PLAN_SANEAMIENTO_REAL.md](./docs/PLAN_SANEAMIENTO_REAL.md).
> Si este archivo se consulta, debe leerse solo como referencia historica del proceso previo.
